...
### Gordon et al. - The Dark side of the Sublime 2017

The authors demonstrate that there is a "dark side of the sublime," elicited by vast and threatening stimuli like tornadoes or terrorist attacks which possesses unique characteristics. Specifically, unlike unlike positive awe, threat-based awe is associated with feelings of powerlessness and fear, low control and certainty. Ultimately, the research establishes that threat-based awe, although sharing core features with positive awe, does not confer the same psychological benefits as its positive counterpart. This study shifts the focus of awe, a component of the sublime, from being a universally positive emotion away from recent bias and back toward its historical roots as a terrifying, yet profound, mixed emotional state.

### Posner, Russel & Peterson - The Circumplex Model of Affect 2005

The circumplex model posits that all emotional experiences emerge from cognitive interpretations of two underlying, independent neurophysiological systems: valence (pleasure-displeasure) and arousal (alertness), mapping the two within a two-dimensional, circular space. This model is one of the most popular approaches used in psychology and neuroscience to conceptualize and measure emotions.
